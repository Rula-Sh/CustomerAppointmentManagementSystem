...
namespace CAMS.Web.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(IManageUsersService manageUsers,
        ...
        public async Task<IActionResult> Add()
        {
            ...
            // to fix this, I moved ViewAddAppointment code here (in Appointments controller) to keep the business logic layers independent and preventing InvalidOperationException from DI container.
